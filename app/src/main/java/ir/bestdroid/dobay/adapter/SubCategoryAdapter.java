...
public class SubCategoryAdapter extends RecyclerView.Adapter<SubCategoryAdapter.Holder_CateGory> {
    ...
    public void onBindViewHolder(@NonNull final Holder_CateGory holder_cateGory, final int position) {
        final SubCategoryModel model=categoryModels.get(position);
    ...
    public interface OnnItemSelect{
        void OnItemClicked(SubCategoryModel categoryModel, int position);
    }
}
